...
pub struct OGVal<'alloc, 'access, ID: OGID, T: 'static + ?Sized> {
    r: &'access T,
    id_imprint: ID::Imprint,
    _alloc_lt: PhantomData<&'alloc T>,
}

impl<'alloc, 'access, ID: OGID, T: 'static + ?Sized> OGVal<'alloc, 'access, ID, T> {
...
impl<'alloc, 'access, ID: OGID, T: 'static> OGVal<'alloc, 'access, ID, T> {
...
impl<'alloc, 'access, ID: OGID, T: 'static + ?Sized> Deref for OGVal<'alloc, 'access, ID, T> {
    type Target = T;
...
impl<'alloc, 'access, ID: OGID, T: 'static> Clone for OGVal<'alloc, 'access, ID, T> {
    fn clone(&self) -> Self {
        *self
    }
}

impl<'alloc, 'access, ID: OGID, T: 'static> Copy for OGVal<'alloc, 'access, ID, T> {}
